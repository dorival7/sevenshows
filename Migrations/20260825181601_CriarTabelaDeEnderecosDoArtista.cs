...
{
    /// <inheritdoc />
    public partial class CriarTabelaDeEnderecosDoArtista : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_artist_addresses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_artist_addresses_users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_artist_addresses_UserId",
